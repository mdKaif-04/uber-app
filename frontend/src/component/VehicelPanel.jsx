...
const VehicelPanel = ({setVehiclePanelOpen,setConfirmRidePanel,fare,selectVehicle}) => {
    ...
    <div>
         <div className="flex relative  ">
                ...
                <div onClick={()=>{setConfirmRidePanel(true)
                        selectVehicle('car')
              }} className="flex w-full p-3 mb-2 items-center bg-gray-100 rounded-xl border-[#5d6060] active:border justify-between">
                  ...
                  <h2 className="text-md text-gray-900 font-semibold">₹{fare.car}</h2>
                </div>
                <div onClick={()=>{setConfirmRidePanel(true)
                  selectVehicle('auto')
                }} className="flex w-full p-3 mb-2  items-center bg-gray-100 rounded-xl border-[#5d6060] active:border justify-between">
                  ...
                  <h2 className="text-md text-gray-900 font-semibold">₹{fare.auto}</h2>
                </div>
                <div onClick={()=>{setConfirmRidePanel(true)
                  selectVehicle('bike')
                }} className="flex w-full  items-center mb-2 bg-gray-100 rounded-xl border-[#5d6060] active:border justify-between">
                  ...
                  <h2 className="text-md text-gray-900 font-semibold pr-4">₹{fare.bike}</h2>
                </div>
    </div>
  )
}
